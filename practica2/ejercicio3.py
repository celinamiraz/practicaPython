...
letra_ingresada = ""
while letra_ingresada == "":
    letra_ingresada = input("Ingresar una letra para buscar en el texto")
    print(letra_ingresada)
    letra_ingresada = es_letra(letra_ingresada)
    print(letra_ingresada)
for elem in palabras:
    if elem.startswith(letra_ingresada) or elem.startswith(letra_ingresada.upper()):
        print(elem)
